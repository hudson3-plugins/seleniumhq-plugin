...
public class SeleniumhqPublisherTest extends HudsonTestCase
{
	...
	public void test1() throws Exception 
	{
        ...
        project.addPublisher(new SeleniumhqPublisher("*.html", false));
	...
	public void test2() throws Exception 
	{
        ...
        System.out.println(project.getPublishersList() + ": size: " + project.getPublishersList().size());
        for (int i = 0; i < project.getPublishersList().size(); i++) {
        	System.out.println("Test: " + project.getPublishersList().get(i));
        }
    ...
    {       
        FreeStyleProject project = createFreeStyleProject();
        project.addPublisher(new SeleniumhqPublisher("*.html", true));
